...
pub fn matrix4x4(comptime T: type) type {
    ...
    return struct {
        ...
        pub fn lookToLh(eyepos: vector(T), eyedir: vector(T), updir: vector(T)) Self {
            ...
            const ay = geometry.normalize3(geometry.cross3(az, ax));
            return .{
                .e = .{
                    .{ ax[0], ay[0], az[0], 0 },
                    .{ ax[1], ay[1], az[1], 0 },
                    .{ ax[2], ay[2], az[2], 0 },
                    .{ -geometry.dot3(ax, eyepos), -geometry.dot3(ay, eyepos), -geometry.dot3(az, eyepos), 1.0 },
                },
            };
        }
        ...
        pub fn inverse(self: *const Self) !Self {
            ...
            var v0: [4]VT = undefined;
            var v1: [4]VT = undefined;
