...
pub fn window_width() i32 {
    ...
    system.print_error("ERR window_width not supported mobile platforms.\n", .{});
    unreachable;
}
pub fn window_height() i32 {
    ...
    system.print_error("ERR window_height not supported mobile platforms.\n", .{});
    unreachable;
}
pub fn window_x() i32 {
    if (root.platform == root.XfitPlatform.windows) {
    ...
    system.print_error("ERR window_x not supported mobile platforms.\n", .{});
    unreachable;
}
pub fn window_y() i32 {
    if (root.platform == root.XfitPlatform.windows) {
    ...
    system.print_error("ERR window_y not supported mobile platforms.\n", .{});
    unreachable;
}
pub fn can_maximize() bool {
    ...
    system.print_error("ERR can_maximize not supported mobile platforms.\n", .{});
    unreachable;
}
pub fn can_minimize() bool {
    ...
    system.print_error("ERR can_minimize not supported mobile platforms.\n", .{});
    unreachable;
}
pub fn can_resizewindow() bool {
    ...
    system.print_error("ERR can_resizewindow not supported mobile platforms.\n", .{});
    unreachable;
}
...
pub fn set_window_mode(pos: math.point(i32), size: math.point(u32), state: system.window_state, _can_maximize: bool, _can_minimize: bool, _can_resizewindow: bool) void {
    if (root.platform == root.XfitPlatform.windows) {
        ...
        system.print_error("ERR monitor_info.set_window_mode not supported mobile platforms.\n", .{});
        unreachable;
    }
